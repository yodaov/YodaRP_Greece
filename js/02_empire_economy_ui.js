...
function resize() {
  ...
  function setActiveMenu(panel) {
    const pairs = [
      ...
      [document.getElementById('menuRoutesBtn'), document.getElementById('panelRoutes'), 'routes'],
      [document.getElementById('menuWarBtn'), document.getElementById('panelWar'), 'war'],
      [menuHeroesBtn, panelHeroes, 'heroes'],
      [menuEventsBtn, panelEvents, 'events'],
      [menuRankingBtn, panelRanking, 'ranking'],
  ...
  function importCampaignState(state) {
    ...
    refreshSelectionPanels();
    refreshEmpirePanels();
    if (typeof refreshHeroPanel === 'function') refreshHeroPanel();
    if (typeof refreshEventPanel === 'function') refreshEventPanel();
    if (typeof refreshRankingPanel === 'function') refreshRankingPanel();
    draw();
