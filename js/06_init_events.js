...
function loadImageElement(uri) {
  ...
  clearAllBtn.addEventListener('click', () => {
    ...
    heroes = [];
    eventLog = [];
    if (typeof tradeRoutes !== 'undefined') tradeRoutes = [];
    if (typeof logisticsRoutes !== 'undefined') logisticsRoutes = [];
    if (typeof sieges !== 'undefined') sieges = [];
    if (typeof raidLog !== 'undefined') raidLog = [];
    passedTimeCount = 0;
    ...
    if (typeof refreshWarPanel === 'function') refreshWarPanel();
    draw();
  });
